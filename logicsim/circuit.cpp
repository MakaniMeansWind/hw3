...
bool Circuit::parse(const char* fname)
{
    ...
    while( getline(inFile, line))
    {
        ...
        std::cout << "Checking for wires!" << std::endl;
        ...
        std::cout << "Checking for GATES!" << std::endl;
        ...
        if(line == "GATES")
        {
            ...
            for(int i = 0;i<n;i++)
            {
                ...
                if(s_type == "AND2")
                {
                    ...
                    std::cout << "s_output is " << s_output << std::endl;
        ...
        std::cout << "Checking for INJECT!" << std::endl;
        ...
        if(line == "INJECT")
        {
            ...
            std::cout << "Commence INJECT!" << std::endl;
            ...
            std::cout << "t_line is: " << t_line << std::endl;
            ...
            for(int i = 0;i<n;i++)
            {
                ...
                std::cout << "s_time is " << s_time << std::endl;
                ...
                std::cout << "s_wire is " << s_wire << std::endl;
                ...
                std::cout << "s_state is " << s_state << std::endl;
                ...
                // std::cout << "Pushed out an e!" << std::endl;
            }
...
void Circuit::startUml(std::ostream& os)
{
    ...
    std::cout << "size of m_wires is " << m_wires.size() << std::endl;
